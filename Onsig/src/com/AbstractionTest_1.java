...
public class AbstractionTest_1
{
      ...
      public static void main(String[] args)
      {
         if (args.length != 3)
         {
            System.out.println("USAGE:  java AbstractionTest timeSeries1 timeSeries2 radius");
            System.exit(1);
         }
         else
         {
            ...
            final WarpPath coarsePath = com.dtw.DTW.getWarpPathBetween(shrunkI, shrunkJ);
            ...
            final TimeWarpInfo info = com.dtw.DTW.getWarpInfoBetween(tsI, tsJ, w);
