...
public class LinearWindow_1 extends SearchWindow
{
   // CONSTANTS
   ...
   // CONSTRUCTORS
   public LinearWindow_1(TimeSeries tsI, TimeSeries tsJ, int searchRadius)
   {
   ...
   public LinearWindow_1(TimeSeries tsI, TimeSeries tsJ)
   {
